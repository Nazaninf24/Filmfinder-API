...
let showResults = (movies) => {
  ...
  if (movies[i].Poster !== "N/A") {
    image = `<img src="${movies[i].Poster}" class="card-img img-fluid" alt="${movies[i].Title}"></img>`
  }
    results.innerHTML += `
      ...
      <div class="row no-gutters">
        ...
        <div class="col-md-8">
          <div class="card-body">
            ...
            <button class="btn btn-primary" id="readmore" onclick="getDetails('${movies[i].imdbID}')
